...
var BEMDOMBlock = inherit(BEM.Block,/** @lends BEMDOMBlock.prototype */{
    ...
    _findBlocks : function(select, elem, block, onlyFirst) {
        ...
        var ctxElem = elem?
            ...
            blockName = isSimpleBlock? block : block.block,
            selector = '.' +
                (isSimpleBlock?
    ...
    _liveClassBind : function(className, e, callback, invokeOnInit) {
        if(e.indexOf(' ') > -1) {
            ...
            if(!storage) {
                ...
                BEMDOM.scope.bind(e, $.proxy(this._liveClassTrigger, this));
            }
...
modules.define = function(name, deps, decl) {
    ...
    name !== 'i-bem-dom_init' && arguments.length > 2 && ~deps.indexOf('i-bem-dom') &&
        modules.define('i-bem-dom_init', [name], function(provide, _, prev) {
            provide(prev);
        });
};
